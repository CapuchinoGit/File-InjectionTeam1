...
<div role="navigation" class="navbar navbar-inverse navbar-static-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="#" class="navbar-brand">Team 1</a> </div>
      <a href="Boton.php" class="navbar-brand">Button</a> </div>
...
<div class="form-group">
              ...
              <label>Por favor escriba el nombre del archivo:
              <input required="" type="text" name="file2" id="exampleInputFile">
              </label>
</div>
